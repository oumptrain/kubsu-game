...
var G__21198 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21198;
continue;
} else {
return ch;
...
var vec__21199 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__21199,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq21202){
...
return (function() { 
var G__21207__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__21207 = function (rdr,var_args){
var _ = null;
...
while (G__21208__i < G__21208__a.length) {G__21208__a[G__21208__i] = arguments[G__21208__i + 1]; ++G__21208__i;}
  _ = new cljs.core.IndexedSeq(G__21208__a,0,null);
} 
return G__21207__delegate.call(this,rdr,_);};
G__21207.cljs$lang$maxFixedArity = 1;
G__21207.cljs$lang$applyTo = (function (arglist__21209){
var rdr = cljs.core.first(arglist__21209);
var _ = cljs.core.rest(arglist__21209);
return G__21207__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1608397894772
