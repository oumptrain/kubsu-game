...
return (new CustomEvent(event_name,(function (){var obj26201 = ({"detail":data});
return obj26201;
})()));
} else {
...
var f = (function (){var pred__26208 = cljs.core._EQ_;
var expr__26209 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26208.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26209))){
return (function (p1__26202_SHARP_){
return console.warn(p1__26202_SHARP_);
});
} else {
if(cljs.core.truth_(pred__26208.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26209))){
return (function (p1__26203_SHARP_){
return console.debug(p1__26203_SHARP_);
});
} else {
if(cljs.core.truth_(pred__26208.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26209))){
return (function (p1__26204_SHARP_){
return console.error(p1__26204_SHARP_);
});
} else {
return (function (p1__26205_SHARP_){
return console.log(p1__26205_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26212){
...
var eval_fn = cljs.core.get.call(null,map__26213__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__26215_SHARP_){
return new_def.callback(p1__26215_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__26216){
var vec__26217 = p__26216;
var ky = cljs.core.nth.call(null,vec__26217,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1608397898113
